    ...
    try {
      ...
      for (let i = 0; i < movieHistory.length; i++) {
        ...
        try {
          ...
          this.log(`✓ Processed: ${movie.title} (${movie.year}) - ${historyEntry.watched_at}`, 'success');
    ...
    try {
      ...
      for (let i = 0; i < watchedMovies.length; i++) {
        ...
        try {
          ...
          const watchDate = watchedMovie.last_watched_at || ratingData?.rated_at || new Date().toISOString();
          ...
          this.log(`✓ Processed: ${movie.title} (${movie.year}) - ${watchedMovie.plays} play(s)`, 'success');
